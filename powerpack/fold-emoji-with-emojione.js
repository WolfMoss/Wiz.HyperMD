...
(function(mod) { //[HyperMD] UMD patched!
    /*commonjs*/
    ("object" == typeof exports && "undefined" != typeof module) ? mod(null, exports, require("emojione"), require("../addon/fold-emoji"), require("emojione/extras/css/emojione.min.css")):
        /*amd*/
        ("function" == typeof define && define.amd) ? define(["require", "exports", "emojione", "../addon/fold-emoji", "emojione/extras/css/emojione.min.css"], mod) :
        /*plain env*/
        mod(null, (this.HyperMD_PowerPack = this.HyperMD_PowerPack || {}, this.HyperMD_PowerPack["fold-emoji-with-emojione"] = {}), emojione, HyperMD.FoldEmoji);
    ...
    exports.emojioneChecker = function(text) {
        return emojione.shortnameToUnicode(text) != text;
    };
