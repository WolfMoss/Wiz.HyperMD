...
(function(mod) { //[HyperMD] UMD patched!
    /*commonjs*/
    ("object" == typeof exports && "undefined" != typeof module) ? mod(null, exports, require("turndown"), require("../addon/paste")):
        /*amd*/
        ("function" == typeof define && define.amd) ? define(["require", "exports", "turndown", "../addon/paste"], mod) :
        /*plain env*/
        mod(null, (this.HyperMD_PowerPack = this.HyperMD_PowerPack || {}, this.HyperMD_PowerPack["paste-with-turndown"] = {}), TurndownService, HyperMD.Paste);
